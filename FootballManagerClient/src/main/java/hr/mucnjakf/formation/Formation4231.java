...
public class Formation4231 implements Formationable {
        ...
        switch (playerPosition) {
            ...
            case "Defender":
                for (int i = 0; i < 4; i++) {
                    ...
                    gpFootballField.add(defSp, i, 3, 2, 1);
                }
                break;
            case "Midfielder":
                for (int i = 0; i < 2; i++) {
                    ...
                    gpFootballField.add(midSp, i + 1, 2, 2, 1);
                }
                for (int i = 0; i < 3; i++) {
                    Circle midC = new Circle(30);
                    Label midL = new Label("MID");
                    ...
                    gpFootballField.add(midSp, i + 1, 1, 1, 1);
                }
                break;
            case "Attacker":
